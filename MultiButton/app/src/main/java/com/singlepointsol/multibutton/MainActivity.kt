package com.singlepointsol.multibutton
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        if (p0 != null) {
            when(p0.id) {
                R.id.goodmorning_button -> parentLayout.setBackgroundResource(R.drawable.gm)
                R.id.goodevening_button -> parentLayout.setBackgroundResource(R.drawable.ge)
                R.id.goodnight_button -> parentLayout.setBackgroundResource(R.drawable.gn)
            }
        }
    }
}